      ...
      <div class="md:h-screen md:flex md:flex-col">
        <div class="md:flex md:flex-shrink-0">
          ...
          <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-md flex justify-between items-center">
            <div class="mt-1 mr-4">{{ $page.props.auth.userName}}</div>
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 shadow-xl bg-white rounded text-sm">
                  <Link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white" :href="`/users/edit/${$page.props.auth.userId}`">
                    My Profile
                  </Link>
                  <Link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white" href="/users">
                    manage users
                  </Link>
                  <Link
